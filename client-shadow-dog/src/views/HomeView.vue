    ...
    <img src="/background/6.png" alt="" id="layer6" class="image-source"/>
      ...
      <div class="info-bet" >
        <div class="current-bet">
          <div class="alert alert-primary custom-alert" role="alert">
            <img src="/assetHorizone/deer/images.jpeg" height="20" width="20">
            9000
            <!-- <link rel="icon" type="image/x-icon" href="/assetHorizone/deer/images.ico"> -->
          </div>
      ...
      <div id="bet-container">
        <div class="row">
          ...
          <button type="button" class="col-6">deer</button>
          <button type="button" class="col-6">bear</button>
        </div>
        <div class="row">
        
          <button type="button" class="col-6">hippo</button>
          <button type="button" class="col-6">giraffe</button>
        </div>
        <div class="row">
          <button type="button" class="col-6">zebra</button>
          <button type="button" class="col-6">elephant</button>
        </div>
      </div>
